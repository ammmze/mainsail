...
<v-container class="d-flex flex-column">
    <v-row dense>
      <v-col cols="6">
        <v-tooltip top color="secondary">
          <template v-slot:activator="{ on }">
            <v-btn block small color="secondary" :class="btnClass" ref="refBtn"
                   class="base-btn" v-on="showTooltip ? on : {}"
      ...
      <v-col cols="6">
        <v-tooltip top color="secondary">
          <template v-slot:activator="{ on }">
            <v-btn block small color="secondary" :class="btnClass"
                   class="base-btn" v-on="showTooltip ? on : {}"
  ...
  <v-row>
    <v-col cols="6">
      <v-tooltip top color="secondary">
        <template v-slot:activator="{ on }">
          <v-btn large block color="secondary" :class="btnClass"
                 class="base-btn wrap-text-btn" v-on="showTooltip ? on : {}"
