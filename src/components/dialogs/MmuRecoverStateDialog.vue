                    ...
                    <v-col class="col-5 d-flex justify-center">
                        <v-row class="d-flex flex-row">
                            <v-col class="d-flex justify-center flex-column">
                                ...
                                <span class="settings-row-subtitle">{{ $t('MmuDialog.MmuRecover.SetTool') }}</span>
                            </v-col>
                        </v-row>
                    </v-col>
                    ...
                    <v-col class="col-5 d-flex justify-center">
                        <v-row class="d-flex flex-row">
                            <v-col class="d-flex justify-center flex-column">
                                ...
                                <span class="settings-row-subtitle">{{ $t('MmuDialog.MmuRecover.SetGate') }}</span>
                            </v-col>
                        </v-row>
                    </v-col>
                    <v-col class="col-5 d-flex justify-end align-center">
                    ...
                    <v-col class="col-5 d-flex justify-center">
                        <v-row class="d-flex flex-row">
                            <v-col class="d-flex justify-center flex-column">
                                ...
                                <span class="settings-row-subtitle">{{ $t('MmuDialog.MmuRecover.FilamentLoaded') }}</span>
                            </v-col>
                        </v-row>
                    </v-col>
                    <v-col class="col-5 d-flex justify-end align-center">
